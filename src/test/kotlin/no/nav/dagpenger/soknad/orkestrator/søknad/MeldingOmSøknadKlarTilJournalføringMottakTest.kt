...
class MeldingOmSøknadKlarTilJournalføringMottakTest {
    ...
    init {
        MeldingOmSøknadKlarTilJournalføringMottak(rapidsConnection, søknadRepository, pdfService)
    }
    ...
    fun `onPacket leser melding og behandler den som forventet`() {
        ...
        verify { pdfService.genererBruttoPdfPayload(ident, søknadId) }
        verify { pdfService.genererNettoPdfPayload(ident, søknadId) }
