...
class KanJobbeHvorSomHelstBehovløserTest {
    ...
    val behovløser = KanJobbeHvorSomHelstBehovløser(testRapid, opplysningRepository, søknadRepository, seksjonRepository)
    val ident = "12345678910"
    val søknadId = UUID.randomUUID()

    @Test
    fun `Behovløser publiserer løsning på behov KanJobbeHvorSomHelst med verdi og gjelderFra`() {
        val opplysning =
            QuizOpplysning(
