...
class HelseTilAlleTyperJobbBehovløserTest {
    ...
    val behovløser = HelseTilAlleTyperJobbBehovløser(testRapid, opplysningRepository, søknadRepository, seksjonRepository)
    val ident = "12345678910"
    val søknadId = UUID.randomUUID()

    @Test
    fun `Behovløser publiserer løsning på behov HelseTilAlleTyperJobb med verdi og gjelderFra`() {
        val opplysning =
            QuizOpplysning(
