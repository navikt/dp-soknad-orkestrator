...
class VilligTilÅBytteYrkeBehovløserTest {
    ...
    val behovløser = VilligTilÅBytteYrkeBehovløser(testRapid, opplysningRepository, søknadRepository, seksjonRepository)
    ...
    @Test
    fun `Behovløser publiserer løsning på behov VilligTilÅBytteYrke med verdi og gjelderFra fra seksjonsdata`() {
        every {
